...
static char NgramStats_RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/NgramStats.cc,v 1.53 2006/12/10 19:39:30 stolcke Exp $";
#endif
...
#include <stdio.h>
#include <errno.h>
#if defined(sgi) || defined(_MSC_VER) || defined(WIN32)
#define fseeko fseek
#define ftello ftell
#endif
					...
					Array<VocabIndex> &vocabMap)
{
	...
	unsigned long long endOffset, trieLength;
	unsigned nbytes;
	...
	if (order == 0) {
		...
		if (wid == Vocab_None) {
		    ...
		    NgramNode *child = node.insertTrie(wid);
