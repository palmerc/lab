...
#ifndef lint
static char Copyright[] = "Copyright (c) 1998-2006 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/AdaptiveMix.cc,v 1.15 2007/01/24 19:47:10 stolcke Exp $";
#endif
...
AdaptiveMix::read(File &file, Boolean limitVocab)
{
	...
	if (sscanf(line, "%lf %99s %d", &weight, filename, &order) < 2) {
