 ...
 *
 * @(#)$Header: /home/srilm/devel/dstruct/src/RCS/Map.h,v 1.22 2006/11/17 11:33:55 stolcke Exp $
 *
 */
...
inline void Map_noKey(long int &key) { key = ShortNokeyValue; }
inline Boolean Map_noKeyP(long int key) { return key == ShortNokeyValue; }
...
inline void Map_noKey(long unsigned &key) { key = UShortNokeyValue; }
inline Boolean Map_noKeyP(long unsigned key) { return key == UShortNokeyValue; }
