...
static char RcsId[] = "@(#)$Header: /home/srilm/devel/flm/src/RCS/ProductNgram.cc,v 1.9 2006/08/11 20:47:15 stolcke Exp stolcke $";
#endif
							...
							unsigned &length)
{
    ...
    unsigned long hash = LHash_hashKey(context, 30);
