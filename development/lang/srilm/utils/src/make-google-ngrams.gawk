...
#
# $Header: /home/srilm/devel/utils/src/RCS/make-google-ngrams.gawk,v 1.3 2006/08/11 22:32:28 stolcke Exp $
#
# usage: zcat counts.gz | make-google-ngrams [dir=DIR] [per_file=N] [gzip=0]
#
...
END {
	...
	if (have_dir[1]) {
		system("gunzip -f < " dir "/1gms/vocab" gzip_suff " | sort +1rn -2 | " gzip_cmd " > " dir "/1gms/vocab_cs" gzip_suff);
	}
}
