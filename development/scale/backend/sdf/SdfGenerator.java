...
/** 
 * This class converts Scribble into Sdf instructions.
 * <p>
 * $Id: SdfGenerator.java,v 1.2 2007-02-15 15:32:11 burrill Exp $
 * <p>
...
public class SdfGenerator extends scale.backend.Generator
{
   ...
   */
  public SdfGenerator(CallGraph cg, Machine machine, int features)
  {
    super(cg, new SdfRegisterSet(), machine, features);

    assert (machine instanceof SdfMachine) : "Not correct machine " + machine;

    this.un = new UniqueName("$$");

    // Determine what additional Sdf features are available.

    SdfMachine am = (SdfMachine) machine;
  ...
  {
    stkPtrReg = SdfRegisterSet.SP_REG;
  ...
  public void assemble(Emit emit, String source, Enumeration<String> comments)
  {
    ...
    SdfAssembler asm = new SdfAssembler(this, source, !nis);
