...
/**
 * This is the base class for all Sdf specific information.
 * <p>
 * $Id: SdfMachine.java,v 1.4 2007-11-01 16:52:30 burrill Exp $
 * <p>
 ...
 */
public class SdfMachine extends Machine
{
  private static final int capabilities = 0;

  /**
   * Create a Machine instance for an Sdf.
   */
  public SdfMachine()
  {
    super(capabilities);
...
//     cacheLineSize = 16;
                                      ...
                                      String extension) throws java.lang.Exception
  {
    ...
    return "scale.backend.sdf.SdfGenerator";
  }
