...
<tr valign="top">
<td width="110" class="bbg"><a href="http://www.ibm.com"><img width="110" src="//www.ibm.com/i/v14/t/ibm-logo.gif" height="52" border="0" alt="IBM"/></a></td><td width="650" class="mbbg" align="right">
...
<!-- Start SP SEARCH ACMEII CODE -->
	<form action="/university/scholars/SearchResults" name="Search" method="get">
	<table cellspacing="0" cellpadding="0" border="0">
	<tr> 
		<td width="18"><label for="scope"><img src="//www.ibm.com/i/c.gif" width="1" height="1" alt="Search in:"/></label></td> 
		<td><select id="scope" name="scope" class="input-local" size="1">
		<option value="sp">Academic Initiative</option>
		<option value="ibm">ibm.com</option>
		</select>
		</td> 
		<td width="7"><label for="query"><img src="//www.ibm.com/i/c.gif" width="1" height="1" alt="Search for:"/></label></td> 
		<td align="right"><input name="query" type="text" value="" id="query" size="15" maxlength="100" class="input" /></td> 
		<td width="7">&nbsp;<input type="hidden" name="v" value="14" /> 
		<input type="hidden" name="lang" value="en"/> 
		<input type="hidden" name="cc" value="us"/>
		<input type="hidden" name="type" value="0" /></td> 
		<td align="left" width="90"><input alt="Search" name="Search" src="//www.ibm.com/i/v14/t/search.gif" type="image" value="Search" /> </td> 
	</tr> 
	</table>
	</form>
...
<!--<td align="right"><span class="masthead-phone">Call&nbsp;1-800-SHOP-IBM&nbsp;&nbsp;&nbsp;&nbsp;</span></td>-->
</tr>
</table>
</td>
</tr>
...
<tr>
	<th class="left-nav-overview" colspan="2"><a class="left-nav-overview" href="/us/en/university/scholars/">IBM Academic Initiative</a></th>
</tr>


<!-- BEGIN NAV STRUCTURE -->
<!-- PARENT LINK ROW: now output by navbar -->

<!-- ///////////////////////// -->
<!-- WCR: NAV BEAN STARTS HERE -->
<!-- ///////////////////////// -->
	<%=leftNav%>
...
<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
	<td><a href="http://www.ibm.com/industries/education/doc/jsp/indseg/highereducation/" class="rlinks">Solutions for higher education</a></td>
</tr>

<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
	<td><a href="http://www.ibm.com/developerworks/" class="rlinks">developerWorks</a></td>
</tr>
<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
	<td><a href="http://www.ibm.com/alphaworks" class="rlinks">alphaWorks</a></td>
</tr>
<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
...
<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
	<td><a href="//www.ibm.com/de/ibm/unternehmen/university_relations/index.html" class="rlinks">IBM Wissenschafts<br />beziehungen in Deutschland</a></td>
</tr>
<tr class="rlinks">
	<td><img src="//www.ibm.com/i/v14/t/rl-bullet.gif" width="2" height="8" alt="" border="0"/></td>
...
<tr>
	...
	<table cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td><span class="spacer">&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="http://www.ibm.com/ibm/us/" class="mainlink">About IBM</a></td>
		<td width="27" class="footer-divider">&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><a href="http://www.ibm.com/privacy/us/" class="mainlink">Privacy</a></td>
		<td width="27" class="footer-divider">&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><a href="http://www.ibm.com/contact/us/" class="mainlink">Contact</a></td>
	</tr>
	</table>
	</td>
</tr>
