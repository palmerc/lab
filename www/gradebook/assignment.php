<?php
function assignment_create($course_key, $section, $term_key)
{
...
function assignment_edit($class_key, $course_key, $section, $term_key)
{
   if (assignment_exists($class_key))
   {
...
function assignment_delete($class_key)
{
   if (assignment_exists($class_key))
   {
      // Query string should contain properly formatted SQL
...
function assignment_get($class_key)
{
   // Query string should contain properly formatted SQL
...
function assignment_exists($class_key)
{
   $result = assignment_get($class_key);
   if ($result)
      return true;
   else
      return false;
