...
/* use register in evaluating str_true() */
	...
	break;
    case O_SLEEP:
	fatal("Unsupported function sleep");
	break;
    case O_RANGE:
	...
	break;
    case O_SYSTEM:
	fatal("Unsupported function system");
	break;
    case O_EXEC_OP:
	fatal("Unsupported function exec");
	break;
    case O_HEX:
	if (maxarg < 1)
	    tmps = str_get(stab_val(defstab));
...
donumset:
    ...
    case O_RENAME:
	fatal("Unsupported function rename");
	break;
    case O_LINK:
	fatal("Unsupported function link");
	break;
    case O_MKDIR:
	fatal("Unsupported function mkdir");
	break;
    case O_RMDIR:
	fatal("Unsupported function rmdir");
	break;
    case O_GETPPID:
