...
------------------------
   A Quick Reference Chart for all the functions in V2.7x is provided in the 
   following .PDF files:
...
--------------------------------------
   A number of services and configuration constants have been added to V2.81 and
   a new Reference and Configuration Manual (Chapter 16 and 17 in the MicroC/OS-II 
   2nd Edition book) have been updated and included in .PDF format on this
