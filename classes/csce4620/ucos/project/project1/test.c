...
void Task1(void *pdata)
{
   ...
   {    
      printf("BEGIN: task 1\n");
      OSMboxPend(Mbox1, 0, &err); /* Pend on Signal from Task 2 */
      //OSTimeDly(500);
...
void  Task2 (void *pdata)
{
   ...
   for(;;) 
   {
      ...
      OSMutexPost(Mutex3); /* Signal Task1 using semaphore */
      printf("END: task 2\n");
   }
}
...
void  Task3 (void *pdata)
{
   ...
   {
      printf("BEGIN: task 3\n");
      OSMutexPend(Mutex3, 0, &err); /* Pend on Signal from Task 1 */
      //OSTimeDly(500);
      ...
      OSMboxPost(Mbox1, (void *)1); /* Signal Task1 using semaphore */
      printf("END: task 3\n");
   }
}
