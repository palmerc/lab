...
EXT int gid;
EXT int egid;
#define getuid() 500		/* SPEC: changed to minimal macros for BM */
#define geteuid() 500		/* SPEC: changed to minimal macros for BM */
#define getgid() 500		/* SPEC: changed to minimal macros for BM */
#define getegid() 500		/* SPEC: changed to minimal macros for BM */
